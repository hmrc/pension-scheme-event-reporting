...
object API1830 extends Transformer {
  ...
  import transformations.UserAnswersToETMP.ReadsUtilities._
  ...
  // TODO - clean up paths in reads methods below
...
private object API1830Paths {
  // ETMP
  val etmpPathToEvent:                                    JsPath = __ \ "memberDetail" \ "event"
  ...
  val etmpPathToPersonReceivedThePayment:                 JsPath = etmpPathToEvent \ "personReceivedThePayment"
  ...
  val etmpPathToMemberStatus:                             JsPath = __ \ "memberDetail" \ "memberStatus"
  val etmpPathToAmendedVersion:                           JsPath = __ \ "memberDetail" \ "amendedVersion"
  val etmpPathToPaymentDetails:                           JsPath = etmpPathToEvent \ "paymentDetails"
  ...
  // UA
  val uaPathToMembersDetails:                             JsPath = __ \ "membersDetails"
  ...
  val uaPathToBenefitType:                                JsPath = __ \ "benefitType"
  val uaPathToAmountCrystallisedAndDateDetails:           JsPath = __ \ "AmountCrystallisedAndDate"
  val uaPathToLumpSumAmountAndDateDetails:                JsPath = __ \ "lumpSumAmountAndDate"

  val uaPathToDeceasedMemberDetails:                      JsPath = __ \ "deceasedMembersDetails"
  ...
  val uaPathToBeneficiaryMemberDetails:                   JsPath = __ \ "beneficiaryDetails"
  ...
  val uaPathToCrystallisedDateEvent24:                    JsPath = __ \ "crystallisedDate"
  ...
  val uaPathToTypeOfProtectionReferenceGroup1:            JsPath = __ \ "typeOfProtectionGroup1Reference"
  ...
  // TODO - order all paths - alphabetical
}
