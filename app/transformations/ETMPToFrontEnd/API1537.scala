...
private object API1537ReadsUtilities extends Transformer {
  ...
  private val readsSubmitter: Reads[JsString] = (
        organisationOrPartnershipNamePath.readNullable[String] and
        firstNamePath.readNullable[String] and
        lastNamePath.readNullable[String]
      )(
...
private object API1537Paths {
  // UA
  val organisationOrPartnershipNamePath:  JsPath = __ \ "reportSubmitterDetails" \ "organisationOrPartnershipDetails" \ "organisationOrPartnershipName"
  val firstNamePath:                      JsPath = __ \ "reportSubmitterDetails" \ "individualDetails" \ "firstName"
  val lastNamePath:                       JsPath = __ \ "reportSubmitterDetails" \ "individualDetails" \ "lastName"

  val uaSubmittedDate:                    JsPath = __ \ "submittedDate"
  val uaSubmitterName:                    JsPath = __ \ "submitterName"
  val uaVersion:                          JsPath = __ \ "versionDetails" \ "version"
  val uaStatus:                           JsPath = __ \ "versionDetails" \ "status"
