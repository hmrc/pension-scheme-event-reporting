...
object MemberEventReport {
  ...
  implicit val rdsMemberDetailsEvent6: Reads[JsObject] = {
    (
      readsMemberDetails and
        ...
        (__ \ Symbol("inputProtectionType")).json.copyFrom((__ \ Symbol("memberDetail") \ Symbol("event") \ Symbol("paymentDetails") \ Symbol("freeText")).json.pick) and
        (__ \ Symbol("AmountCrystallisedAndDate") \ Symbol("amountCrystallised")).json.copyFrom((__ \ Symbol("memberDetail") \ Symbol("event") \ Symbol("paymentDetails") \ Symbol("amountCrystalised")).json.pick) and
        (__ \ Symbol("AmountCrystallisedAndDate") \ Symbol("crystallisedDate")).json.copyFrom((__ \ Symbol("memberDetail") \ Symbol("event") \ Symbol("paymentDetails") \ Symbol("eventDate")).json.pick)
      ).reduce
  }
  ...
  implicit val rdsMemberDetailsEvent7: Reads[JsObject] = {
    (
      readsMemberDetails and
        (__ \ Symbol("lumpSumAmount")).json.copyFrom((__ \ Symbol("memberDetail") \ Symbol("event") \ Symbol("paymentDetails") \ Symbol("amountLumpSum")).json.pick) and
        (__ \ Symbol("crystallisedAmount")).json.copyFrom((__ \ Symbol("memberDetail") \ Symbol("event") \ Symbol("paymentDetails") \ Symbol("amountCrystalised")).json.pick) and
        (__ \ Symbol("paymentDate") \ Symbol("date")).json.copyFrom((__ \ Symbol("memberDetail") \ Symbol("event") \ Symbol("paymentDetails") \ Symbol("eventDate")).json.pick)
      ).reduce
  }
